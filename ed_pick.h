...
//    mat4_t transform;
    ...
    void (*compute_view_projection_matrix)(mat4_t *view_projection_matrix, mat4_t *widget_transform);
...
//void ed_WidgetViewProjectionMatrix(struct ed_widget_t *widget, mat4_t *view_projection_matrix);
