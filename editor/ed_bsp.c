...
//{
//    struct ed_clipped_polygon_t *splitter = polygons;
//    struct ed_clipped_polygon_t *best_splitter = NULL;
//    uint32_t best_split_count = 0xffffffff;
//
//    while(splitter)
//    {
//        struct r_vert_t *splitter_vertex = (struct r_vert_t *)splitter->vertices.buffer;
//        struct ed_clipped_polygon_t *polygon = splitter->next;
//        uint32_t split_count = 0;
//
//        while(polygon)
//        {
//            if(ed_PolygonOnSplitter(polygon, &splitter_vertex->pos, &splitter_vertex->normal.xyz) == ED_SPLITTER_SIDE_STRADDLE)
//            {
//                split_count++;
//            }
//
...
//{
//    struct ed_clipped_polygon_t *splitter = NULL;
//    struct ed_clipped_polygon_t *last_splitter = NULL;
//    struct ed_clipped_polygon_t *side_lists[2] = {NULL, NULL};
