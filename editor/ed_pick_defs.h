...
enum ED_PICKABLE_TYPE_MASKS
{
    ...
    ED_PICKABLE_TYPE_MASK_ENEMY = 1 << ED_PICKABLE_TYPE_ENEMY,
...
#define ED_PICKABLE_OBJECT_MASK (ED_PICKABLE_TYPE_MASK_BRUSH | ED_PICKABLE_TYPE_MASK_ENTITY | ED_PICKABLE_TYPE_MASK_LIGHT | ED_PICKABLE_TYPE_MASK_ENEMY)
